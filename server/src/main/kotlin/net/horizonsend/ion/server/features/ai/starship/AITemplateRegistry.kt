...
object AITemplateRegistry {
	...
	// START_WATCHER
	val VERDOLITH_REINFORCEMENT = registerTemplate(
		builder(
	...
	val VERDOLITH_REINFORCED = registerTemplate(
		builder(
	...
	// END_WATCHER
	// START_吃饭人
	val MALINGSHU_REINFORCEMENT = registerTemplate(
		builder(
	...
	val MIANBAO_REINFORCEMENT = registerTemplate(
		builder(
	...
	val MIANBAO_REINFORCED = registerTemplate(
		builder(
	...
	val BLOODSTAR = registerTemplate(
		builder(
			...
			.addRewardProvider(CreditRewardProviderConfiguration(5000.0))
			.addRewardProvider(AITemplate.KillStreakRewardProviderConfiguration(2000.0))
			.addAdditionalModule(
				BehaviorConfiguration.BasicReinforcementInformation(
					activationThreshold = 0.85,
	...
	val BULWARK = registerTemplate(
		builder(
			...
			.addRewardProvider(SLXPRewardProviderConfiguration(0.8))
			.addRewardProvider(CreditRewardProviderConfiguration(7000.0))
			...
			.addAdditionalModule(
				BehaviorConfiguration.AdvancedReinforcementInformation(
					...
					BagSpawner.asReinforcement(
						...
						asBagSpawned(SYSTEM_DEFENSE_FORCES.asSpawnedShip(TENETA).withRandomRadialOffset(100.0, 200.0, 0.0), 2),
						asBagSpawned(SYSTEM_DEFENSE_FORCES.asSpawnedShip(CONTRACTOR).withRandomRadialOffset(75.0, 100.0, 0.0), 3),
						asBagSpawned(SYSTEM_DEFENSE_FORCES.asSpawnedShip(BULWARK).withRandomRadialOffset(0.0, 75.0, 0.0), 9),
						asBagSpawned(SYSTEM_DEFENSE_FORCES.asSpawnedShip(BULWARK).withRandomRadialOffset(0.0, 75.0, 0.0), 10),
					)(it)
				})
			.build()
	)
	...
	val CONTRACTOR = registerTemplate(
		builder(
			...
			.addFactionConfiguration(SYSTEM_DEFENSE_FORCES)
			.addRewardProvider(SLXPRewardProviderConfiguration(0.8))
			.addRewardProvider(CreditRewardProviderConfiguration(4500.0))
			.addRewardProvider(AITemplate.KillStreakRewardProviderConfiguration(3000.0))
			.build()
	)
	...
	val WOODPECKER = registerTemplate(
		builder(
			...
			.addFactionConfiguration(AIFaction.MINING_GUILD)
			.addRewardProvider(SLXPRewardProviderConfiguration(0.6))
			.addRewardProvider(CreditRewardProviderConfiguration(1000.0))
			.addRewardProvider(AITemplate.KillStreakRewardProviderConfiguration(1500.0))
			.addAdditionalModule(
				BehaviorConfiguration.BasicReinforcementInformation(
	...
	// Baits
	val BAIT_WAYFINDER = registerTemplate(
		builder(
	...
	val BAIT_NIMBLE = registerTemplate(
		builder(
